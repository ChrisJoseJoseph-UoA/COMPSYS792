...
For every terminal, source the enviroment: source /opt/ros/noetic/setup.bash && source /root/livox_ws/devel/setup.bash && source /root/catkin_ws/devel/setup.bash
